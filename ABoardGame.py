...
Returns: string
Method signature: def whoWins(self, board):
Limits
Time limit (s): 2.000
Memory limit (MB): 256
Constraints
...
class ABoardGame:
    def whoWins(self, board):
        ...
        for Ni in range(self.N):
            numA, numB = self.count_pieces(board, Ni)
            if numA > numB:
                return "Alice"
            elif numA < numB:
                return "Bob"
    ...
    def count_pieces(self, board, Ni):
        numA = numB = 0
        beg = self.N - Ni - 1
        end = self.N + Ni
...
M = ABoardGame()
board = (".....A", "......", "..A...", "...B..", "......", "......")
print(M.whoWins(board))

board = ("AAAA", "A.BA", "A..A", "AAAA")
print(M.whoWins(board))

board = ("..", "..")
print(M.whoWins(board))

board = ("BBB..BAB...B.B", ".AAAAAAAAAAAA.", "AA.AA.AB..A.AB", "..........B.AB", ".A..BBAB.A.BAB", ".AB.B.......A.", ".A..A.AB.A..AB", ".ABAA.BA...BA.", "BAAAB.....ABA.", ".A....B..A..B.", "B...B....B..A.", "BA.B..A.ABA.A.", "BAAAA.AAAAA.A.", "B.B.B.BB.B....")
print(M.whoWins(board))

board = ("..A..AAA..AA", "ABABB..AAAAA", "ABBBBBBBBBA.", "AABBBABABBAA", "...BABABABBA", "B.BA..A.BBA.", "AA.A..B.AB.B", "..BA.B.AABAA", "..ABABBBABA.", ".ABB.BBBBBAA", "ABAAA.AA.A.A", "A..AAA.AAA.A")
print(M.whoWins(board))

board = ("B..ABAABBB", "B.........", "A..A.AA..B", "A.BBBAA..A", "B.AAAAB...", "A..BBBBB.A", "B..ABAABBA", "A......B.B", "B......A.A", "BA.AABBB.A")
print(M.whoWins(board))
